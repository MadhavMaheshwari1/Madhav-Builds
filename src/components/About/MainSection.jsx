    ...
    return (
        <MainSectionStyles data-scroll-section className="main">
            ...
            <div className="main-text">
                ...
                <p>Outside of work, I have a deep interest in fitness training, especially weight training.</p>
            </div>
        </MainSectionStyles>
    )
}
